...
let cam={x:0,y:0,accx:0,accy:0,speed:0.1,zoom:0,goal:{x:0,y:0}}
...
if(scene===4){
  ...
  var playButton=button(width-50,height/2,100,100)
  ...
  fill(255)
  textSize(40)
  text("Play",width-50,height/2+12)
  if(playButton[0]){
