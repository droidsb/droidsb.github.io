        ...
        for (var x = Vx1; x < Vx2; x++) {
            for (var y = Vy1; y < Vy2; y++) {
                ...
                if (chunks[x][y] !== undefined) {
                    ...
                    if (x * 100 - Players[CurrentPlayer].x + (width / 2) > -100 && x * 100 - Players[CurrentPlayer].x + width / 2 < width && y * 100 - Players[CurrentPlayer].y + height / 2 > -250 && y * 100 - Players[CurrentPlayer].y + height / 2 < height) {
